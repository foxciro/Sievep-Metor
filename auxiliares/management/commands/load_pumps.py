        ...
        with atomic():
            ...
            for pump in data:
                ...
                detalles_motor = DetallesMotorBomba.objects.create(
                    potencia = self.clean_text(pump["potencia"]),
                    potencia_unidad = Unidades.objects.get(simbolo = "HP"),
                    velocidad = self.clean_text(pump["velocidadmotor"]),
                    velocidad_unidad = Unidades.objects.get(simbolo = "RPM"),
                ...
                especificaciones_bomba = EspecificacionesBomba.objects.create(
                    ...
                    potencia_unidad = Unidades.objects.get(simbolo = "BHP"),
                ...
                condicion_fluido_bomba = CondicionFluidoBomba.objects.create(
                    fluido = Fluido.objects.get(cas = "7732-18-5"), # Agua
                ...
                condicion_diseno_bomba = CondicionesDisenoBomba.objects.create(
                    capacidad = self.clean_text(pump["capacidad"]),
                    capacidad_unidad = Unidades.objects.get(simbolo = "m3/h"),
